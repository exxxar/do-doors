...
<table border="1">
    ...
    <tr>
        @foreach($materials as $item)
            <td width="100px" style="font-weight: bold;text-align: center;border:1px solid #111;">Число петель</td>
    ...
    @foreach($prices as $index=>$item)
        ...
        <tr style="background: red;">
            ...
            @foreach ($item->prices  as $price)
                ...
                @endphp
                <td width="100px"
                    style="text-align: center;border:1px solid #111;background-color: {{$bg}};">{{$price->value ?? '-'}}</td>
                <td width="100px"
