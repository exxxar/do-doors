...
<template>
    ...
    <div class="row mb-3">
        <div class="col-md-6 col-12">
            <button
                type="button"
                class="btn btn-dark rounded-0" @click="resetForm">Очистить форму
            </button>
        </div>
    </div>
        ...
        <div class="row">
            ...
            <div class="col-md-6 col-12">
                <div class="form-floating mb-3">
                    <input type="email"
                           v-model="form.email"
                           class="form-control" id="client-email">
            ...
            <div class="col-md-6 col-12">
                <div class="form-floating mb-3">
                    <input type="text"
                           v-model="form.phone"
                           v-mask="'+7(###)###-##-##'"
                           class="form-control" id="client-phone">
            ...
            <div class="col-md-6 col-12  mb-3">
                ...
                <div class="input-group ">
                    ...
                    <div class="form-floating">
                        <input type="text"
                               v-model="form.inn"
                               maxlength="12"
                               class="form-control" id="client-inn" required>
                ...
                <a :href="'https://egrul.nalog.ru/vyp-download/'+link_for_document"
                   target="_blank"
                   class="btn btn-link my-0 py-0 px-0"
                   style="color:red;"
                   v-if="link_for_document">Скачать выписку</a>
            ...
            <div class="col-md-6 col-12">
                <div class="form-floating mb-3">
                    <input type="text"
                           maxlength="9"
                           v-model="form.kpp"
                           class="form-control" id="client-kpp">
            ...
            <div class="col-md-6 col-12">
                <div class="form-floating mb-3">
                    <input type="text"
                           maxlength="15"
                           v-model="form.ogrn"
                           class="form-control" id="client-ogrn">
            ...
            <div class="col-md-6 col-12">
                <div class="form-floating mb-3">
                    <input type="text"
                           v-model="form.okpo"
                           maxlength="10"
                           class="form-control" id="client-okpo">
        ...
        <div class="row">
            <div class="col-12 my-2">
                <button
                    type="button"
                    @click="addRequisites"
                    class="btn btn-dark rounded-0"><i class="fa-solid fa-plus mr-1"></i>Добавить расчётный счёт
                </button>
            </div>
                    ...
                    <div class="card-header d-flex justify-between align-items-center  border-secondary">
                        ...
                        <div class="form-check form-switch ">
                            <input class="form-check-input"
                                   @change="changeRequisitesMain(index)"
                                   v-model="form.requisites[index].is_main"
                                   type="checkbox" role="switch" :id="'form-requisites-checking_account'+index" checked>
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6 col-12">
                                <div class="input-group mb-3">
                                    <div class="form-floating">
                                        <input type="text"
                                               maxlength="11"
                                               v-model="form.requisites[index].bik"
                                    ...
                                    <button
                                        type="button"
                                        :disabled="!form.requisites[index].bik"
                                        @click="requestByBik(index)"
                                        class="btn btn-outline-secondary rounded-0"><i
                            ...
                            <div class="col-md-6 col-12">
                                <div class="form-floating mb-3">
                                    <input type="text"
                                           v-model="form.requisites[index].bank"
                                           class="form-control" :id="'form-requisites-bank'+index">
                            ...
                            <div class="col-md-12 col-12">
                                <div class="form-floating mb-3">
                                    <input type="text"
                                           v-model="form.requisites[index].address"
                                           class="form-control" :id="'form-requisites-address'+index">
                            ...
                            <div class="col-md-6 col-12">
                                <div class="form-floating mb-3">
                                    <input type="text"
                                           maxlength="20"
                                           v-model="form.requisites[index].correspondent_account"
                                           class="form-control" :id="'form-requisites-correspondent_account'+index">
                            ...
                            <div class="col-md-6 col-12">
                                <div class="form-floating">
                                    <input type="text"
                                           v-model="form.requisites[index].checking_account"
                                           maxlength="20"
        ...
        <div class="modal-dialog modal-lg ">
            <div class="modal-content rounded-0 border-secondary">
                ...
                <div class="modal-body 0">
                    <UserTable
                        :for-select="true"
                        v-on:select="selectUserId"></UserTable>
                </div>
