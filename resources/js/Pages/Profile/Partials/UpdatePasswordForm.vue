    ...
    <section>
        <header>
            ...
            <p class="mt-1 text-sm text-gray-600">
               Убедитесь что ваш аккаунта надежно засищещен крепким паролем!
            </p>
        </header>
        ...
        <form @submit.prevent="updatePassword" class="mt-6 space-y-6">
            ...
            <div>
                <InputLabel for="password" value="Новый парольы" />
            ...
            <div>
                <InputLabel for="password_confirmation" value="Подвтердить пароль" />
