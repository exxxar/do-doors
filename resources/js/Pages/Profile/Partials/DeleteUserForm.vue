    ...
    <section class="space-y-6">
        <header>
            ...
            <p class="mt-1 text-sm text-gray-600">
                ...
                введите свой пароль, чтобы подтвердить, что вы хотите навсегда удалить свою учетную запис
            </p>
        </header>

        <DangerButton @click="confirmUserDeletion">Удаление аккаунта</DangerButton>
        ...
        <Modal :show="confirmingUserDeletion" @close="closeModal">
            <div class="p-6">
                ...
                <div class="mt-6 flex justify-end">
                    <SecondaryButton @click="closeModal"> Отменить </SecondaryButton>
