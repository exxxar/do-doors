<script setup>
import OpenAppLayout from '@/Layouts/OpenAppLayout.vue';
...
defineProps(['doors','order'])
</script>

<template>
    <Head title="Информация о заказе" />

    <OpenAppLayout>
        <template #header>
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">Информация о двери</h2>
        </template>
